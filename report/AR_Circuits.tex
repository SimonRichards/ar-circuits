...
\begin{abstract}
Our project aims to develop an electronic circuit simulator
to aid in the teaching of elementary electrical principles. 
It will allow users to freely design a circuit constrained 
only by the space they have available. The circuit will be 
analysed and the real-time voltage and current levels will 
be displayed dynamically and intuitively by the models 
